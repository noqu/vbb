...
/*------------------------ FLAT_SET ----------------------------*/
/* Liefert eine flache Kopie der menge 'set' in 'flat'. Der
 * Speicherplatz fuer 'flat' muss von der rufenden Funktion bereit-
 * gestellt werden.
 */
...
/*------------------------ UNFLAT_SET --------------------------*/
/* Erzeugt aus der flachen Datenstruktur 'flat' eine Menge. Der
 * Speicherplatz fuer die Menge wird von der rufenden Funktion
 * bereitgestellt.
 */
...
/*------------------------ SIZEOF_FLAT_SET ---------------------*/
/* Liefert die Groesse einer flachen Menge, aufgerundet auf die
 * naechste Word-Alignment-Grenze der verwendeten Architektur.
 */
